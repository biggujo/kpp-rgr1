...
public class FileArrayListInterpolator extends ArrayListInterpolator {
    ...
    private static final String FILE_FUNCTION = "TableClassicFunction.csv";
    private static final String FILE_INTERPOLATION = "TableInterpolatedFunction.csv";
    ...
    public static void main(String[] args) {
        ...
        try {
            interpolator.writeToFile(FILE_FUNCTION);
        } catch (IOException e) {
            e.printStackTrace();
        }

        try {
            interpolator.readFromFile(FILE_FUNCTION);
        } catch (IOException e) {
            e.printStackTrace();
        }
